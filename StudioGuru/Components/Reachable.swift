...
class Reachable: NSObject
{
    ...
    init?(hostName: String) {
        ...
        super.init()
        self.sharedData.addEventListener(title: "GO_LOGOUT", target: self, selector: #selector(self.stopNotifier))
    ...
    static func networkReachabilityForLocalWiFi() -> Reachable? {
        ...
        return Reachable(hostAddress: localWifiAddress)
    }
